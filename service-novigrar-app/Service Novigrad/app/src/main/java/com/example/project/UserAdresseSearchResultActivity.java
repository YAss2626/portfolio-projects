...
public class UserAdresseSearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_adresse_search_result);

        //Variables
        Intent intent = getIntent();
        String searchedAdresse = intent.getStringExtra("adresse");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (snapshot.hasChild(searchedAdresse)) {
