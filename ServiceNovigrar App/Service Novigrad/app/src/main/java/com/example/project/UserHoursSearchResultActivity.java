...
public class UserHoursSearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_hours_search_result);

        //Variables
        Intent intent = getIntent();
        String searchedHours = intent.getStringExtra("service");
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (snapshot.hasChild(searchedHours)) {
